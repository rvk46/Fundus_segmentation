...
# pre_processing.py
from pre_processing import my_PreProcess


path_data = './STARE_datasets_training_testing/'


STARE_test_imgs_original = path_data + 'STARE_dataset_imgs_test.hdf5'
test_imgs_orig = load_hdf5(STARE_test_imgs_original)
full_img_height = test_imgs_orig.shape[2]
full_img_width = test_imgs_orig.shape[3]

STARE_test_border_masks = path_data + 'STARE_dataset_borderMasks_test.hdf5'
test_border_masks = load_hdf5(STARE_test_border_masks)
...
if average_mode == True:
    patches_imgs_test, new_height, new_width, masks_test = get_data_testing_overlap(
        STARE_test_imgs_original = STARE_test_imgs_original,  #original
        STARE_test_groudTruth = path_data + 'STARE_dataset_groundTruth_test.hdf5',  #masks
        Imgs_to_test = 20,
