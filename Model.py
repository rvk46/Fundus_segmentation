...
#Definining the neural network. There is U-net for the mainstream task and the other one with slight changes for exception handling issues
...
#Define the other NN
def get_unet_alt(n_ch,patch_height,patch_width):
